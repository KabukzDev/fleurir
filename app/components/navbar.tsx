    ...
    <nav className="relative z-50">
      <div className="w-full flex items-center justify-between px-6 py-3 backdrop-blur-xl bg-mist-950">
        ...
        <div className="pr-2 flex items-center gap-6 font-normal text-base">
          ...
          {user ? (
            /* The 'group' class here is the secret sauce */
            <div className="group relative flex items-center py-2">
              <img 
                className="h-10 w-10 rounded-full cursor-pointer border border-white/10" 
                src={user.image} 
                alt={user.name} 
              />
              ...
              <div className="absolute top-full right-0 mt-1 w-48
                              ...
                              transition-all duration-200 transform origin-top-right group-hover:translate-y-0 translate-y-1">
